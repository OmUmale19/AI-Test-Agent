...
function WorkspaceBody() {
    ...
    return (
        <div className="max-w-6xl mx-auto mt-6 px-6 md:px-10">
            ...
            {/* Connect GitHub Card */}
            <div className="border border-gray-700/80 bg-zinc-900/60 rounded-2xl p-4 px-6 flex items-center justify-between shadow-lg backdrop-blur-sm hover:border-gray-600 transition-all">
